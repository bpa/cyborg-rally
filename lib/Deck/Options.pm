...
Flywheel:After all players are done programming their registers each turn, you may put one of your remaining Program cards face down onto this card.  You can add that Program card to those dealt to you on any subsequent turn.  You can have only one card on Flywheel at a time.
